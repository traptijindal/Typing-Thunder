      ...
      <div className='flex flex-col md:flex-row justify-between lg:mt-16'>
        ...
        <div className="right w-full md:w-[40%] text-white">
          ...
          <form onSubmit={handleSubmit}>
            ...
            />
            <button className='w-full mb-4 lg:mb-6 bg-white text-black border border-white rounded-xl py-2 lg:py-3 pl-2 pr-8 text-center text-base lg:text-xl font-semibold' type="submit">Done</button>
          </form>
