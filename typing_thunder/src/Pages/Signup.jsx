     ...
     <div className=' text-sm lg:text-lg md:hidden gap-[8px]'>
      ...
      <div className='flex justify-between'>
        ...
        <div className='right w-full md:w-[40%]'>
             ...
             <p className='text-[#B3B3B3] text-xs md:text-sm lg:text-base mb-4 md:mb-6'>Sign Up to test your typing speed with your companions.</p>
            <div className='block w-full'>
            <input type="text" placeholder='Enter email' className='w-full md:w-[45%] text-black bg-[#1A1A1A] mb-4 lg:mb-6 border border-white rounded-xl py-4 pl-2 pr-8 text-sm lg:text-lg mr-5'/>
            <input type="text" placeholder='Username' className='w-full md:w-[45%] text-black bg-[#1A1A1A] mb-4 lg:mb-6 border border-white rounded-xl py-4 pl-2 pr-8 text-sm lg:text-lg'/>
            </div>
             ...
             <button 
              className='w-full mb-4 lg:mb-6 bg-white text-black border border-white rounded-xl py-2 lg:py-4 pl-2 pr-8 text-center  text-base lg:text-xl font-semibold flex justify-center items-center' 
