    ...
    <div>
      {!timeUp ? (
        ...
        <div>
          ...
          <ActionButtons onRestart={resetUserInput} handleNext={handleNext} />
...
//   const handleAddPunctuation = () => {
//     const randomPunctuation = generatePunctuation();
//     setGeneratedText(randomPunctuation);
//     setAddPunctuation(randomPunctuation);
//     resetTypingStats();
//   };
...
//     setUserInput(value);
//     const correctCharCount = value.split('').reduce((acc, char, index) => {
//       return acc + (char === generatedText[index] ? 1 : 0);
//     }, 0);
...
//       const words = correctChars / 5; // Number of words typed correctly
//       const minutes = (60 - timeLeft) / 60; // Time elapsed in minutes
//       setSpeed((words / minutes).toFixed(2)); // Speed in WPM
//     }
//   }, [totalChars, correctChars, timeLeft]);
...
//   <>
//    <p className='text-center text-white mb-6'>Time:{timeLeft}</p>
//     <p className='text-center text-white mb-6'>Speed: {speed} WPM</p>
//     <p className='text-center text-white mb-6'>Accuracy: {accuracy} %</p>
//   </>
// )}
//           {showButtons &&(
//           <div className='flex justify-center space-x-6 mb-6'>
//             <div className='flex flex-col items-center'>
//               <div className='flex justify-between items-center rounded-3xl p-3 bg-[black] text-[#4D4D4D] font-medium w-20 border-2 border-[#333333] shadow-sm shadow-black'>
//                 <p className='cursor-pointer' onClick={handleAddPunctuation} onMouseEnter={() => handleHover1('Add Punctuation')} onMouseLeave={handleMouseLeave1}>@</p>
//                 <p className='cursor-pointer' onClick={handleAddNumbers} onMouseEnter={() => handleHover1('Add Numbers')} onMouseLeave={handleMouseLeave1}>#</p>
//               </div>
//               {hoverText1 && <p className='text-center text-white mt-2 bg-[#666666] py-2 px-4'>{hoverText1}</p>}
//             </div>

//             <div className='flex flex-col items-center'>
//               <div className='flex justify-between items-center rounded-3xl p-3 bg-black text-[#4D4D4D] font-medium w-56 border-2 border-[#333333] shadow-sm shadow-black'>
//                 <p><Clock3 className="cursor-pointer" onMouseEnter={() => handleHover2('Time')} onMouseLeave={handleMouseLeave2} /></p>
//                 <img src={quotes} alt="quote" className='cursor-pointer' onClick={handleQuoteClick} onMouseEnter={() => handleHover2('Quotes')} onMouseLeave={handleMouseLeave2} />
//                 <img src={T} alt="text" className='text-[#4D4D4D] cursor-pointer' onMouseEnter={() => handleHover2('Words')} onMouseLeave={handleMouseLeave2} />
//               </div>
//               {hoverText2 && <p className='text-center text-white mt-2 bg-[#666666] py-2 px-4'>{hoverText2}</p>}
//             </div>
